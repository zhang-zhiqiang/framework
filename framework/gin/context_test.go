...
import (
	...
	testdata "github.com/gin-gonic/gin/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/gin-gonic/gin/framework/gin.handlerNameTest$", c.HandlerName())
}
